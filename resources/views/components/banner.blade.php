...
<div x-data="{{ json_encode(['show' => true, 'style' => $style, 'message' => $message]) }}"
    :class="{ 'bg-emerald-600': style == 'success', 'bg-rose-700': style == 'danger', 'bg-amber-500': style == 'warning', 'bg-slate-600': style != 'success' && style != 'danger' && style != 'warning'}"
            style="display: none;"
            x-show="show && message"
    ...
    <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between flex-wrap">
            <div class="w-0 flex-1 flex items-center min-w-0">
                <span class="flex p-2 rounded-lg" :class="{ 'bg-emerald-700': style == 'success', 'bg-rose-800': style == 'danger', 'bg-amber-600': style == 'warning' }">
            ...
            <div class="shrink-0 sm:ms-3">
                <button
                    ...
                    :class="{ 'hover:bg-emerald-700 focus:bg-emerald-700': style == 'success', 'hover:bg-rose-800 focus:bg-rose-800': style == 'danger', 'hover:bg-amber-600 focus:bg-amber-600': style == 'warning'}"
                    aria-label="Dismiss"
