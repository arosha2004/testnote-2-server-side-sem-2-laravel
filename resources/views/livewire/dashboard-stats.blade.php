<div>
    <div class="mb-4 flex items-center justify-between">
        <h2 class="text-sm font-semibold uppercase tracking-wider text-slate-500">Overview</h2>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="stat-card">
            <div class="flex items-start justify-between">
                <div>
                    <p class="text-sm font-medium text-slate-500">Total Notes</p>
                    <p class="mt-2 text-3xl font-bold tracking-tight text-slate-900">{{ $totalNotes }}</p>
                    <p class="mt-1 text-xs text-slate-400">In your library</p>
                </div>
        ...
        <div class="stat-card">
            <div class="flex items-start justify-between">
                <div>
                    <p class="text-sm font-medium text-slate-500">Pinned</p>
                    <p class="mt-2 text-3xl font-bold tracking-tight text-slate-900">{{ $pinnedNotes }}</p>
                    <p class="mt-1 text-xs text-slate-400">Priority notes</p>
                </div>
        ...
        <div class="stat-card">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-bold tracking-tight text-slate-900">{{ $totalCategories }}</p>
                    <p class="mt-1 text-xs text-slate-400">Used in your notes</p>
                </div>
        ...
        <div class="stat-card">
            <div class="flex items-start justify-between">
                <div>
                    <p class="text-sm font-medium text-slate-500">Pending Reminders</p>
                    <p class="mt-2 text-3xl font-bold tracking-tight text-slate-900">{{ $totalReminders }}</p>
